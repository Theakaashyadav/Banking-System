//Banking Record System , C++ Project by Akash. 
#include <iostream>
...
int main() {
    ...
    do {
        ...
        case '8':
            cout << "\n\n\tThanks for using Bank Record System.\n\n\tFor more cool stuff, visit https//github.com/theakaashyadav";
            cin >> my_url;
            my_url = toupper(my_url);
            if (my_url == 'Y') {
                system("start https://github.com/theakaashyadav");
            }
            break;
        default:
            cout << "\a";
...
void Credit() {
    system_clear();
    cout << "\n\nBanking Record System Project by Akash." << "\nWritten in C++.";
}